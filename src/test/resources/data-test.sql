...
-- Insert data for profiles first
...
VALUES
    (1, '1988-04-15', 'TestCity', 'TestCountry', 'Male', 'TestDisease', '2020-01', 'Amsterdam UMC', 'Conventional', 'Mix', 'http://localhost:8080/images/Male1.jpg', 'TestHealer1', true),
...
VALUES
    (1, 'John', 'Doe', 'test@example.com', '$2a$10$mS3PIxd001kO4Wh1BouV7e9TFA7tEUKWCwDLjZIyGOHpkqruJQe0a', true, '2023-01-01', '2024-10-05 10:15:30', true, 'What is your favorite color?', 1),
